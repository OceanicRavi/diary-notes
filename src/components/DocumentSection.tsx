          ...
          {section.files.length > 0 && (
            <div className="mt-6">
                    ...
                    <li key={index} className="bg-gray-50 rounded-lg border border-gray-200">
                      <div className="flex items-center justify-between px-4 py-3">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {!fileIsPDF && !fileIsSheet && (
                            <button
                              onClick={() => convertToPDF(file, index)}
                              disabled={conversionStatus[fileId] === 'converting'}
                              className={`text-xs bg-blue-500 hover:bg-blue-600 text-white py-1 px-2 rounded transition-colors ${conversionStatus[fileId] === 'converting' ? 'opacity-50 cursor-wait' : ''
                                }`}
                            >
                          ...
                          {fileIsPDF && (
                            <>
                              ...
                              <button
                                ...
                                disabled={conversionStatus[fileId] === 'converting'}
                                className={`text-xs bg-blue-500 hover:bg-blue-600 text-white py-1 px-2 rounded transition-colors flex items-center ${conversionStatus[fileId] === 'converting' ? 'opacity-50 cursor-wait' : ''
                                  }`}
                              >
                                {conversionStatus[fileId] === 'converting' ? (
                                  <span className="flex items-center">
                              ...
                              <button
                                ...
                                disabled={conversionStatus[fileId] === 'converting'}
                                className={`text-xs bg-green-500 hover:bg-green-600 text-white py-1 px-2 rounded transition-colors flex items-center ${conversionStatus[fileId] === 'converting' ? 'opacity-50 cursor-wait' : ''
                                  }`}
                              >
                                {conversionStatus[fileId] === 'converting' ? (
                                  <span className="flex items-center">
              ...
              <button
                ...
                className={`mt-4 btn btn-primary w-full flex items-center justify-center gap-2 ${section.status === 'processing' ? 'opacity-50 cursor-not-allowed' : ''
                  }`}
              >
